<template>
  <footer class="bg-gray-800 text-white py-2 text-xs">
    <div class="container mx-auto px-4">
      ...
      <div class="hidden md:block text-center text-gray-400">
        &copy; {{ new Date().getFullYear() }} BarHound. All rights reserved.
      </div>
    </div>
  </footer>
</template>
